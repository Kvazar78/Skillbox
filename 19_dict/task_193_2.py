...
print('члены команды из команды А, которые отдыхают', team_a_members)
print('члены команды из группы B, которые тренируются', team_b_members)
print('члены команды из команды C, которые путешествуют', team_c_members)