...
#
# Напишите программу, которая преобразует списки во множества и убирает повторяющиеся элементы. Затем удаляет минимальный
# элемент из каждого множества и добавляет туда случайное число в диапазоне от 100 до 200. Затем выполните следующие
...
num_nums_1 = random.randint(100, 200)
num_nums_2 = random.randint(100, 200)
print('Случайное число для 1-го множества:', num_nums_1)
print('Случайное число для 2-го множества:', num_nums_2)

nums_1.add(num_nums_1)
nums_2.add(num_nums_2)
