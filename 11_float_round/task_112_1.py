# Нас наняла букмекерская контора, где проводятся ставки на конный
# спорт. Напишите программу расчёта потенциального выигрыша игрока.
...
#
# Усложнение задачи: сделайте так, чтобы после точки выводилось не больше
# двух цифр.
bet = float(input('Сколько ставим? '))
coefficient = float(input('Какой коэффициент? '))

gain = round(bet * coefficient, 2)

print(f'Потенциальный выигрыш: {gain}')