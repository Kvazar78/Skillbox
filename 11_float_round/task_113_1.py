...
# валют. В программу вводится количество чатлов, а она сообщает сколько это CR и сколько кораблей можно купить на
# эту сумму.
#
# Пример 1:
# Сколько чатлов? 3150
...
print(f'Это {money / 2200} CR')
print(f'Можно купить кораблей: {int((money / 2200) / 0.5)}')