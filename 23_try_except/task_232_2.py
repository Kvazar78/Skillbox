...
# и выводит результат в новый файл result.txt в формате «имя — возраст». Программа должна обрабатывать следующие ошибки и
...
try:
    file_to_read = open('ages.txt', 'r')
    file_to_write = open('result.txt', 'a')
